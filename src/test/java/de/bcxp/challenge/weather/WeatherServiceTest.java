...
public class WeatherServiceTest {
	...
	void testDayWithSmallestTemperatureSpread_WithEmptyList() {
		...
		// when
		final String result = this.underTest.dayWithSmallestTemperatureSpread();
		// then
	...
	@Test
	void testDayWithSmallestTemperatureSpread_WithDegreeBelowZeroSuccessful() {
		// given
	...
	@Test
	void testDayWithSmallestTemperatureSpread_WithZeroTempSpreadSuccessful() {
		// given
		final WeatherModel w1 = mockData(1, 0d, 10d);
		final WeatherModel w2 = mockData(2, 5d, 5d);
